...
var ThriftModule = &idl.ThriftModule{Name: "containers", Package: "go.uber.org/thriftrw/gen/testdata/containers", FilePath: "containers.thrift", SHA1: "bb2b06a31ccbbcfce43163a9b0d50f109e21a24b", Includes: []*idl.ThriftModule{enums.ThriftModule, enum_conflict.ThriftModule, typedefs.ThriftModule, uuid_conflict.ThriftModule}, Raw: rawIDL}
