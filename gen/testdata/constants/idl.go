...
var thriftModule = idl.ThriftModule{Name: "constants", Package: "go.uber.org/thriftrw/gen/testdata/constants", FilePath: "constants.thrift", SHA1: "b92b943136c5fc8b1574c092cedc2538682e5525", Includes: []idl.ThriftModule{exceptions.ThriftModule(), structs.ThriftModule(), unions.ThriftModule(), typedefs.ThriftModule(), other_constants.ThriftModule(), containers.ThriftModule(), enums.ThriftModule()}, Raw: rawIDL}
